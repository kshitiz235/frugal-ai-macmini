...
* [Mac Mini M4 24 GB](components/hardware/apple-m4-mini-24gb.md)
* [Apple Mac 64 GB](components/hardware/apple-mac-64gb.md)
* [NVIDIA DGX Spark](components/hardware/nvidia-dgx-spark.md)

## Components — Runtimes

* [Ollama](components/runtimes/ollama.md)
* [LM Studio](components/runtimes/lm-studio.md)
* [MLX vs GGUF](components/runtimes/mlx-vs-gguf.md)
...
* [Dify](components/frameworks/dify.md)
* [Agentic Frameworks](components/frameworks/agentic-frameworks.md)

## Components — Environments

* [Development](components/environments/development.md)
...
* [Dev Environment — Mac Mini 24 GB](runbooks/dev-environment-mac-mini-24gb.md)
* [Open WebUI Operations](runbooks/open-webui-ops.md)
* [Local LLM Service](runbooks/local-llm-service-ops.md)
